	  ...
	  if(file_exists($upfile))
	  {
			...
			if(is_uploaded_file($_FILES["file"]["tmp_name"]))
			{
				...
				else /*Successfully upload file*/
				{
					...
					$insert="INSERT INTO keywords(mediaid,keyword)values('$mediaid','$time')";
					$queryresult = mysqli_query($con, $insert)
						  or die("Insert into Media error in media_upload_process.php " .mysqli_error($con));
					$insert="INSERT INTO keywords(mediaid,keyword)values('$mediaid','$size')";
					$queryresult = mysqli_query($con, $insert)
						  or die("Insert into Media error in media_upload_process.php " .mysqli_error($con));
					$insert="INSERT INTO keywords(mediaid,keyword)values('$mediaid','$ext')";
					$queryresult = mysqli_query($con, $insert)
						  or die("Insert into Media error in media_upload_process.php " .mysqli_error($con));
